        ...
        <Tabs.Group
                ...
                <Tabs.Item title="Active" active={true}>
                    <div>
                       ...
                       <SellerOrdersTable orders={activeOrders} />
                    </div>
                </Tabs.Item>
                <Tabs.Item
                ...
                >
                     <div>
                       ...
                       <SellerOrdersTable orders={deliveredOrders} />
                    </div>  
                </Tabs.Item>
                <Tabs.Item title="Completed">
                  <div>
                       ...
                       <SellerOrdersTable orders={completedOrders} />
                    </div>   
                </Tabs.Item>
                ...
                <div>
                       ...
                       <SellerOrdersTable orders={cancelledOrders} />
                    </div> 
                </Tabs.Item>
                </Tabs.Group>
    </div>
...
export default SellerOrdersPageTab